...
TASKS="onset,speech,volume,gpt2_surprisal,word_length"
SPLIT="WithinSession"
SAVE_BASE="eval_results/fgat_benchmark_v2"
...
echo "  Tasks   : $TASKS"
echo "  Output  : $SAVE_BASE  (new folder — v1 results in fgat_benchmark/)"
echo "========================================================"
echo ""
...
echo ""
echo "Parse results:"
echo "  python parse_fgat_benchmark.py eval_results/fgat_benchmark_v2"
echo "========================================================"
